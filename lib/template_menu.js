...
async function setTemplateMenu(naze, type, m, prefix, setv, db, options = {}) {
	...
	const ucapanWaktu = jam < '05:00:00' ? '*Good Morning* 🇰🇪🌟' : jam < '11:00:00' ? '*Hello* @🇰🇪' : jam < '15:00:00' ? '*Good Afternoon* 🇰🇪' : jam < '18:00:00' ? '*Good evening* 🇰🇪' : jam < '19:00:00' ? '*Good Night* 🇰🇪' : jam < '23:59:00' ? '*Good Midnight* 🇰🇪' : '*Welcome to Kenya* 🇰🇪🌌';
